...
public class SupportApiFactory
    : WebApplicationFactory<global::Support.API.Controllers.SupportController>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureServices(services =>
        {
            ...
            services.AddDbContext<UniversityDbContext>(o =>
                o.UseInMemoryDatabase("UniversityTestDb")
            );
    ...
    private static void RemoveDbContext<T>(IServiceCollection services)
        where T : DbContext
    {
